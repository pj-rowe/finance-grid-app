...
export const BudgetDetail = (props: IBudgetDetailProps) => {
  useEffect(() => {
    props.getEntity(props.match.params.id);
  }, []);

  const { budgetEntity } = props;
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="financeGridApp.budget.detail.title">Budget</Translate> [<b>{budgetEntity.id}</b>]
        </h2>
        ...
        <Button tag={Link} to="/budget" replace color="info">
