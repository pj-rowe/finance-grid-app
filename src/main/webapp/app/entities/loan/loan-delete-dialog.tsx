...
export const LoanDeleteDialog = (props: ILoanDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="financeGridApp.loan.delete.question">
        <Translate contentKey="financeGridApp.loan.delete.question" interpolate={{ id: loanEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-loan" color="danger" onClick={confirmDelete}>
