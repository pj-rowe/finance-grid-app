...
import org.duttydev.financegrid.config.ApplicationProperties
...
class FinanceGridApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes FinanceGridApp.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<FinanceGridApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(FinanceGridApp::class.java)
