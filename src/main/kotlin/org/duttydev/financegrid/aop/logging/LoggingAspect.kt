package org.duttydev.financegrid.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.duttydev.financegrid.repository..*)" +
            " || within(org.duttydev.financegrid.service..*)" +
            " || within(org.duttydev.financegrid.web.rest..*)"
    )
